...
public class FollowTrajectoryPathPlanner extends SequentialCommandGroup {

  // Declare swerve subsystem
  SwerveSubsystem SWERVE_SUBSYSTEM;

  /** Creates a new FollowTrajectory. */
  public FollowTrajectoryPathPlanner(SwerveSubsystem swerve, String path) {
    ...
    PathPlannerTrajectory loaded_trajectory = PathPlanner.loadPath(
          path, 
