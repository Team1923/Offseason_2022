...
package frc.robot.pathplanning.dependencies;
 ...
 */
public class MKITrajectoryConfig {
   ...
   */
  public MKITrajectoryConfig addConstraint(TrajectoryConstraint constraint) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig addConstraints(List<? extends TrajectoryConstraint> constraints) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig setKinematics(DifferentialDriveKinematics kinematics) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig setKinematics(MecanumDriveKinematics kinematics) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig setKinematics(SwerveDriveKinematics kinematics) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig setStartVelocity(double startVelocityMetersPerSecond) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig setEndVelocity(double endVelocityMetersPerSecond) {
   ...
   * @return Instance of the current config object.
   */
  public MKITrajectoryConfig setReversed(boolean reversed) {
    m_reversed = reversed;
    return this;
  }
}
