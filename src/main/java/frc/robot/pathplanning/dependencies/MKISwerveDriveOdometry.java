 ...
 */
public class MKISwerveDriveOdometry {
   ...
   */
  public MKISwerveDriveOdometry(
      MKISwerveDriveKinematics kinematics, Rotation2d gyroAngle, Pose2d initialPose) {
   ...
   * @param gyroAngle The angle reported by the gyroscope.
   */
  public MKISwerveDriveOdometry(MKISwerveDriveKinematics kinematics, Rotation2d gyroAngle) {
