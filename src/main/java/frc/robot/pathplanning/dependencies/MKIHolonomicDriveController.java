...
public class MKIHolonomicDriveController {
  ...
  public MKIHolonomicDriveController(
  ...
  public MKIChassisSpeeds calculate(
    ...
    if (!m_enabled) {
      return MKIChassisSpeeds.fromFieldRelativeSpeeds(xFF, yFF, thetaFF, currentPose.getRotation());
    }
    ...
    // Return next output.
    return MKIChassisSpeeds.fromFieldRelativeSpeeds(
