...
public class MKIChassisSpeeds {
   ...
   */
  public static MKIChassisSpeeds fromFieldRelativeSpeeds(
      double vxMetersPerSecond,
      double vyMetersPerSecond,
      double omegaRadiansPerSecond,
      Rotation2d robotAngle) {
    
    //System.out.println("X PART: " + (vxMetersPerSecond * robotAngle.getCos()) + "    Y PART: " + (vyMetersPerSecond * robotAngle.getCos()) + "    TOTAL: " + ((vxMetersPerSecond * robotAngle.getCos()) + (vyMetersPerSecond * robotAngle.getSin())));
    return new MKIChassisSpeeds(
  ...
  public String toString() {
    return String.format(
        "MKIChassisSpeeds(Vx: %.2f m/s, Vy: %.2f m/s, Omega: %.2f rad/s)",
