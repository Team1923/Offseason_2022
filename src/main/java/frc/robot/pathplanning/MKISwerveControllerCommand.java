...
public class MKISwerveControllerCommand extends CommandBase {
  ...
  public void execute() {
   ...
   // SmartDashboar.putNumber("Partial Angle", partialAngle);
   ...
   // SmartDashboar.putString("Target Chassis Speeds", targetChassisSpeeds.toString());
   // SmartDashboar.putString("Desired State", desiredState.toString());
