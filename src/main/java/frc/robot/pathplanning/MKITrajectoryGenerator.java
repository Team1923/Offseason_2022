...
/** Add your docs here. */
public class MKITrajectoryGenerator{
  ...
  private MKITrajectoryGenerator() {}
   ...
   */
  public static Trajectory generateTrajectory(
      Pose2d start, List<Translation2d> interiorWaypoints, Pose2d end, double startVel, double endVel) {
    ...
    trajectoryConfig.setStartVelocity(startVel);
    trajectoryConfig.setEndVelocity(endVel);
