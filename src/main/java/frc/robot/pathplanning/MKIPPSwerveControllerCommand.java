...
public class MKIPPSwerveControllerCommand extends CommandBase {
    private final Timer m_timer = new Timer();
    private final MKIPathPlannerTrajectory m_trajectory;
    ...
    public MKIPPSwerveControllerCommand(
            MKIPathPlannerTrajectory trajectory,
        ...
        m_controller = new MKIHolonomicDriveController(
                xController,
                yController,
                thetaController);
    ...
    public void execute() {
        ...
        var desiredState = (MKIPathPlannerTrajectory.PathPlannerState) m_trajectory.sample(curTime);
