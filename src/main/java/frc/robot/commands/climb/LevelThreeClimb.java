...
public class LevelThreeClimb extends SequentialCommandGroup {
  /** Creates a new ClimbSequence. */
  public LevelThreeClimb(HoodSubsystem HOOD_SUBSYSTEM, ClimbSubsystem CLIMB_SUBSYSTEM, Supplier<Boolean> commit, StateHandler stateHandler, MKIPicoColorSensor colorSensor) {
